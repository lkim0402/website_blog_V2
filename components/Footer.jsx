export function Footer() {
  return (
    <div className="mb-12 mt-25 mx-10">
      <p className="text-center mb-2 text-wrap text-gray-700 dark:text-gray-300">
        Built with Next.js, Tailwind CSS, MongoDB.
      </p>
      <p className="text-center mb-2 text-sm text-gray-500 dark:text-blue-300">
      ...
      <div className="flex flex-row items-center justify-center gap-2">
        ...
        >
          <svg
            ...
            height="25"
            viewBox="0 0 24 24"
            className="fill-gray-700 transition-all duration-300 dark:fill-blue-200 dark:hover:fill-blue-100 hover:scale-110 hover:fill-gray-400"
          >
            <path
              fillRule="evenodd"
        ...
        >
          <svg
            ...
            height="30"
            viewBox="-6 0 32 32"
            className="fill-gray-700transition-all duration-300 hover:scale-110 hover:fill-gray-400 dark:fill-blue-200 dark:hover:fill-blue-100"
          >
        ...
        >
          <svg
            ...
            className="fill-gray-700 transition-all duration-300 hover:scale-110 hover:fill-gray-400 dark:fill-blue-200 dark:hover:fill-blue-100"
          >
            <path
